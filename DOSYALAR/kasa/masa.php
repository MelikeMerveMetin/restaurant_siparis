...
<html lang="en">
    ...
    <body>
            ...
            <div class="row justify-content-center h-100">
                ...
                <div class="col-lg-9">
                    <div class="row"><?php  $siparis->vipTemaMasalar($db); ?></div>
                        ...
                        <div class="col-lg-12"><a href="../index.php" class="btn btn-success">ANASAYFAYA DÖN</a></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 basliklar">
                                    <div class="row basliklar">
                                        ...
                                        <div class="col-lg-4"><?php $siparis->siparistoplam($db); ?></div>
                                    </div>
                                    ...
                                    <div class="row basliklar">
                                        ...
                                        <div class="col-lg-4"><?php $siparis->doluluk($db); ?></div>
                                    </div>
                                    ...
                                    <div class="row basliklar">
                                        ...
                                        <div class="col-lg-4"><?php $siparis->masatoplam($db); ?></div>
                                    </div>
                                    ...
                                    <div class="row basliklar">
                                        ...
                                        <div class="col-lg-4"><?php $siparis->garsonbak($db); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-lg-12" >
                            <div class="row" >
                                <div class="col-lg-12 basliklar">
                                    <h5 class="pt-2" >
                                        MUTFAK SİPARİŞLERİ <kbd style="background-color: purple;"><?php  echo $siparis->bekleyensatir($db); ?></kbd>
                                    </h5>
                                </div>
  ...
  $b=$siparis->sorgular($db,"select * from garson",1); while ($garsonlar=$b->fetch_assoc()) : ?>
