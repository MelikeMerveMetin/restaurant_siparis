...
$siparis = new Siparis;
$veri=$siparis->sorgular($db,"select * from garson where durum=1",1)->num_rows; if ($veri==0) : header("Location:masa.php"); endif; @$masaid=$_GET["masaid"]; ?>
...
$son=$siparis->masagetir($db,$masaid); $dizi=$son->fetch_assoc(); ?>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-4 masadetaysagcizgi" id="a1">
                                    <a href="masa.php" class="btn anasayfabuton"><i class="fas fa-arrow-left" style="font-size: 38px;"></i></a>
                                </div>
